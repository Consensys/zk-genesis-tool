...
export const bootnodesQuestion: QuestionTree = {
  name: "bootnodes",
  prompt:
    "Choose number of bootnode node keys to generate: (integer) Default: 1",
};

export const membersQuestion: QuestionTree = {
  name: "members",
  prompt: "Choose number of member node keys to generate: (integer) Default: 0",
};

export const validatorsQuestion: QuestionTree = {
  name: "validators",
  prompt:
    "Choose number of validator node keys to generate: (integer) Default: 1",
};
...
export const blockPeriodQuestion: QuestionTree = {
  name: "blockperiod",
  prompt: "Set your blockperiodseconds value: (integer) Default: 1",
};

export const chainIDQuestion: QuestionTree = {
  name: "chainID",
  prompt: "Set your chainID value: (integer) Default: 18021982",
};
